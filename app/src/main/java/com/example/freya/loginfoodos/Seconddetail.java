...
public class Seconddetail extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seconddetail);
...
//                    mButton.setText(R.string.str_btn_stop);
    ...
    public void loc(View view){
        ...
        if ( !manager.isProviderEnabled( LocationManager.GPS_PROVIDER ) ) {
            ...
            Intent intent = new Intent(android.content.Intent.ACTION_VIEW,
                    Uri.parse("http://maps.google.com/maps?daddr=13.007964, 80.262356"));
    ...
    {
        String address=" New No 24/41, Besant Avenue Road, Adayar, Chennai, Tamil Nadu 600020";
        String number=" 044 2491 3226";
        String website="www.avvaiashram.org";
