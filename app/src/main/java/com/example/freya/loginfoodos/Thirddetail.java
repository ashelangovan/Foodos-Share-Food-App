...
public class Thirddetail extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thirddetail);
...
//                    mButton.setText(R.string.str_btn_stop);
    ...
    public void loc(View view){
        ...
        if ( !manager.isProviderEnabled( LocationManager.GPS_PROVIDER ) ) {
            ...
            Intent intent = new Intent(android.content.Intent.ACTION_VIEW,
                    Uri.parse("http://maps.google.com/maps?daddr=13.140635, 80.168559"));
    ...
    {
        String address="1, Ashram St, Murugambedu, Kallikuppam, Ambattur, Chennai, Tamil Nadu 600053";
        String number=" 044 2686 4607";
        String website="www.balagurukulamtrust.org";
